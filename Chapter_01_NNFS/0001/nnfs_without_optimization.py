...
def feedforward_backpropagation():
    # neuron h1 and h2
    ...
    # Applying Gradient On weights third layer
    ...
    # Gradient Optimiser third layer
    weights5_updated = weights5[0]-0.1*de_total_by_Dw5
    weights6_updated = weights6[0]-0.1*de_total_by_Dw6
    weights7_updated = weights7[0]-0.1*de_total_by_Dw7
    weights8_updated = weights8[0]-0.1*de_total_by_Dw8

    # Applying Gradient On weights second layer
    ...
    # Gradient Optimiser third layer
    weights1_updated = weights1[0]-0.1*d_total_by_w1
    weights2_updated = weights2[0]-0.1*d_total_by_w2
    weights3_updated = weights3[0]-0.1*d_total_by_w3
    weights4_updated = weights4[0]-0.1*d_total_by_w4

    # Updating Weights
    weights1[0] = weights1_updated
    weights2[0] = weights2_updated
    weights3[0] = weights3_updated
    weights4[0] = weights4_updated
    weights5[0] = weights5_updated
    weights6[0] = weights6_updated
    weights7[0] = weights7_updated
    weights8[0] = weights8_updated
    print(out_y1, out_y2)
